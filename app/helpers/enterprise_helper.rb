module EnterpriseHelper
  ...
  def global_search_keywords_for(item, children = [])
    ...
    aliases = {
      ...
      "costos" => ["costos", "gastos", "centro de costo", "centros de costo"],
      "cobros_operativos" => ["cobros", "cobros operativos", "cuentas por cobrar"],
      "facturas" => ["facturación", "facturacion", "facturas", "factura"],
      "contratos" => ["contratos", "contrato", "renovaciones"],
